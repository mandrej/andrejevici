...
import { fakeHistory, isAuthorOrAdmin } from "../helpers";
import notify from "../helpers/notify";
import type { PhotoType } from "../helpers/models";

import PictureCard from "../components/Picture-Card.vue";
import SwiperView from "../components/dialog/Swiper-View.vue";
...
const ConfirmDelete = defineAsyncComponent(
  () => import("../components/dialog/Confirm-Delete.vue"),
);
...
const findPhoto = async (c: string) => {
  let rec: PhotoType | null | undefined = objects.value.find(
    (x) => x.filename === c,
  );
